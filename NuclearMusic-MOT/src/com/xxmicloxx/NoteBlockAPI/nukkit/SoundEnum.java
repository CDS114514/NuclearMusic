...
public enum SoundEnum {
    ...
    BLOCK_CREAKING_HEART_SPAWN_MOB("block.creaking_heart.spawn_mob"),
    BLOCK_CREAKING_HEART_STEP("block.creaking_heart.step"),
    BLOCK_CREAKING_HEART_TRAIL("block.creaking_heart.trail"),
    BLOCK_DEADBUSH_AMBIENT("block.deadbush.ambient"),
    ...
    BLOCK_DRIED_GHAST_STATE_CHANGE("block.dried_ghast.state_change"),
    BLOCK_DRIED_GHAST_STEP("block.dried_ghast.step"),
    BLOCK_DRY_GRASS_AMBIENT_ATTACHED("block.dry_grass.ambient.attached"),
    ...
    BLOCK_FIREFLY_BUSH_AMBIENT("block.firefly_bush.ambient"),
    ...
    BLOCK_RESIN_BRICK_BREAK("block.resin_brick.break"),
    BLOCK_RESIN_BRICK_FALL("block.resin_brick.fall"),
    BLOCK_RESIN_BRICK_HIT("block.resin_brick.hit"),
    BLOCK_RESIN_BRICK_PLACE("block.resin_brick.place"),
    BLOCK_RESIN_BRICK_STEP("block.resin_brick.step"),
    BLOCK_SAND_AMBIENT("block.sand.ambient"),
    ...
    BREAK_COPPER_BULB("break.copper_bulb"),
    BREAK_COPPER_GRATE("break.copper_grate"),
    ...
    BREAK_WEB("break.web"),
    BREAK_WET_SPONGE("break.wet_sponge"),
    ...
    CLOSE_DOOR_COPPER("close_door.copper"),
    ...
    FALL_COPPER_BULB("fall.copper_bulb"),
    ...
    HIT_COPPER_BULB("hit.copper_bulb"),
    HIT_CORAL("hit.coral"),
    ...
    MOB_ARMADILLO_AMBIENT("mob.armadillo.ambient"),
    MOB_ARMADILLO_BRUSH("mob.armadillo.brush"),
    MOB_ARMADILLO_DEATH("mob.armadillo.death"),
    MOB_ARMADILLO_EAT("mob.armadillo.eat"),
    MOB_ARMADILLO_HURT("mob.armadillo.hurt"),
    MOB_ARMADILLO_HURT_REDUCED("mob.armadillo.hurt_reduced"),
    MOB_ARMADILLO_LAND("mob.armadillo.land"),
    MOB_ARMADILLO_PEEK("mob.armadillo.peek"),
    MOB_ARMADILLO_ROLL("mob.armadillo.roll"),
    MOB_ARMADILLO_SCUTE_DROP("mob.armadillo.scute_drop"),
    MOB_ARMADILLO_STEP("mob.armadillo.step"),
    MOB_ARMADILLO_UNROLL_FINISH("mob.armadillo.unroll_finish"),
    MOB_ARMADILLO_UNROLL_START("mob.armadillo.unroll_start"),
    ...
    MOB_BOGGED_AMBIENT("mob.bogged.ambient"),
    MOB_BOGGED_DEATH("mob.bogged.death"),
    MOB_BOGGED_HURT("mob.bogged.hurt"),
    MOB_BOGGED_STEP("mob.bogged.step"),
    MOB_BREEZE_CHARGE("mob.breeze.charge"),
    MOB_BREEZE_DEATH("mob.breeze.death"),
    MOB_BREEZE_DEFLECT("mob.breeze.deflect"),
    MOB_BREEZE_HURT("mob.breeze.hurt"),
    MOB_BREEZE_IDLE_AIR("mob.breeze.idle_air"),
    MOB_BREEZE_IDLE_GROUND("mob.breeze.idle_ground"),
    MOB_BREEZE_INHALE("mob.breeze.inhale"),
    MOB_BREEZE_JUMP("mob.breeze.jump"),
    MOB_BREEZE_LAND("mob.breeze.land"),
    MOB_BREEZE_SHOOT("mob.breeze.shoot"),
    MOB_BREEZE_SLIDE("mob.breeze.slide"),
    MOB_BREEZE_WHIRL("mob.breeze.whirl"),
    ...
    MOB_CREAKING_ACTIVATE("mob.creaking.activate"),
    MOB_CREAKING_AMBIENT("mob.creaking.ambient"),
    MOB_CREAKING_ATTACK("mob.creaking.attack"),
    MOB_CREAKING_DEACTIVATE("mob.creaking.deactivate"),
    MOB_CREAKING_DEATH("mob.creaking.death"),
    MOB_CREAKING_FREEZE("mob.creaking.freeze"),
    MOB_CREAKING_SPAWN("mob.creaking.spawn"),
    MOB_CREAKING_STEP("mob.creaking.step"),
    MOB_CREAKING_SWAY("mob.creaking.sway"),
    MOB_CREAKING_TWITCH("mob.creaking.twitch"),
    MOB_CREAKING_UNFREEZE("mob.creaking.unfreeze"),
    ...
    MOB_GHASTLING_AMBIENT("mob.ghastling.ambient"),
    MOB_GHASTLING_DEATH("mob.ghastling.death"),
    MOB_GHASTLING_HURT("mob.ghastling.hurt"),
    MOB_GHASTLING_SPAWN("mob.ghastling.spawn"),
    ...
    MOB_HAPPY_GHAST_AMBIENT("mob.happy_ghast.ambient"),
    MOB_HAPPY_GHAST_DEATH("mob.happy_ghast.death"),
    MOB_HAPPY_GHAST_GOGGLES_DOWN("mob.happy_ghast.goggles_down"),
    MOB_HAPPY_GHAST_GOGGLES_UP("mob.happy_ghast.goggles_up"),
    MOB_HAPPY_GHAST_HARNESS_EQUIP("mob.happy_ghast.harness_equip"),
    MOB_HAPPY_GHAST_HARNESS_UNEQUIP("mob.happy_ghast.harness_unequip"),
    MOB_HAPPY_GHAST_HURT("mob.happy_ghast.hurt"),
    MOB_HAPPY_GHAST_RIDE("mob.happy_ghast.ride"),
    ...
    MOB_HORSE_HORSE_ARMOR_UNEQUIP("mob.horse.horse_armor_unequip"),
    ...
    MOB_LLAMA_CARPET_UNEQUIP("mob.llama.carpet_unequip"),
    ...
    MOB_PARROT_IMITATE_CREAKING("mob.parrot.imitate_creaking"),
    ...
    MOB_WOLF_BIG_BARK("mob.wolf.big.bark"),
    MOB_WOLF_BIG_DEATH("mob.wolf.big.death"),
    MOB_WOLF_BIG_GROWL("mob.wolf.big.growl"),
    MOB_WOLF_BIG_HURT("mob.wolf.big.hurt"),
    MOB_WOLF_BIG_PANTING("mob.wolf.big.panting"),
    MOB_WOLF_BIG_WHINE("mob.wolf.big.whine"),
    MOB_WOLF_CUTE_BARK("mob.wolf.cute.bark"),
    MOB_WOLF_CUTE_DEATH("mob.wolf.cute.death"),
    MOB_WOLF_CUTE_GROWL("mob.wolf.cute.growl"),
    MOB_WOLF_CUTE_HURT("mob.wolf.cute.hurt"),
    MOB_WOLF_CUTE_PANTING("mob.wolf.cute.panting"),
    MOB_WOLF_CUTE_WHINE("mob.wolf.cute.whine"),
    MOB_WOLF_DEATH("mob.wolf.death"),
    MOB_WOLF_GROWL("mob.wolf.growl"),
    MOB_WOLF_GRUMPY_BARK("mob.wolf.grumpy.bark"),
    MOB_WOLF_GRUMPY_DEATH("mob.wolf.grumpy.death"),
    MOB_WOLF_GRUMPY_GROWL("mob.wolf.grumpy.growl"),
    MOB_WOLF_GRUMPY_HURT("mob.wolf.grumpy.hurt"),
    MOB_WOLF_GRUMPY_PANTING("mob.wolf.grumpy.panting"),
    MOB_WOLF_GRUMPY_WHINE("mob.wolf.grumpy.whine"),
    MOB_WOLF_HURT("mob.wolf.hurt"),
    MOB_WOLF_MAD_BARK("mob.wolf.mad.bark"),
    MOB_WOLF_MAD_DEATH("mob.wolf.mad.death"),
    MOB_WOLF_MAD_GROWL("mob.wolf.mad.growl"),
    MOB_WOLF_MAD_HURT("mob.wolf.mad.hurt"),
    MOB_WOLF_MAD_PANTING("mob.wolf.mad.panting"),
    MOB_WOLF_MAD_WHINE("mob.wolf.mad.whine"),
    MOB_WOLF_PANTING("mob.wolf.panting"),
    MOB_WOLF_PUGLIN_BARK("mob.wolf.puglin.bark"),
    MOB_WOLF_PUGLIN_DEATH("mob.wolf.puglin.death"),
    MOB_WOLF_PUGLIN_GROWL("mob.wolf.puglin.growl"),
    MOB_WOLF_PUGLIN_HURT("mob.wolf.puglin.hurt"),
    MOB_WOLF_PUGLIN_PANTING("mob.wolf.puglin.panting"),
    MOB_WOLF_PUGLIN_WHINE("mob.wolf.puglin.whine"),
    MOB_WOLF_SAD_BARK("mob.wolf.sad.bark"),
    MOB_WOLF_SAD_DEATH("mob.wolf.sad.death"),
    MOB_WOLF_SAD_GROWL("mob.wolf.sad.growl"),
    MOB_WOLF_SAD_HURT("mob.wolf.sad.hurt"),
    MOB_WOLF_SAD_PANTING("mob.wolf.sad.panting"),
    MOB_WOLF_SAD_WHINE("mob.wolf.sad.whine"),
    ...
    OPEN_DOOR_COPPER("open_door.copper"),
    OPEN_TRAPDOOR_COPPER("open_trapdoor.copper"),
    ...
    RANDOM_TOAST_RECIPE_UNLOCKING_IN("random.toast_recipe_unlocking_in"),
    RANDOM_TOAST_RECIPE_UNLOCKING_OUT("random.toast_recipe_unlocking_out"),
    ...
    STEP_COPPER_BULB("step.copper_bulb"),
    STEP_COPPER_GRATE("step.copper_grate"),
    ...
    STEP_TUFF("step.tuff"),
    STEP_TUFF_BRICKS("step.tuff_bricks"),
    STEP_VINES("step.vines"),
    STEP_WEB("step.web"),
    STEP_WET_SPONGE("step.wet_sponge"),
    STEP_WOOD("step.wood"),
    ...
    TRIAL_SPAWNER_BREAK("trial_spawner.break"),
    ...
    TRIAL_SPAWNER_HIT("trial_spawner.hit"),
    TRIAL_SPAWNER_OPEN_SHUTTER("trial_spawner.open_shutter"),
    TRIAL_SPAWNER_PLACE("trial_spawner.place"),
    TRIAL_SPAWNER_SPAWN_MOB("trial_spawner.spawn_mob"),
    TRIAL_SPAWNER_STEP("trial_spawner.step"),
    ...
    UI_HARDCORE_DISABLE("ui.hardcore_disable"),
    UI_HARDCORE_ENABLE("ui.hardcore_enable"),
    UI_HARDCORE_TOGGLE_PRESS("ui.hardcore_toggle_press"),
